<%@ Page Language="C#" MasterPageFile="~/WI.Master"  AutoEventWireup="true" CodeBehind="SuspExpDaysLost.aspx.cs" Inherits="SligoCS.Web.WI.SuspExpDaysLost" %>
...
<table style="padding:0px 0px 0px 0px; width:400px;">
 <tr><td><uc2:ParamsLinkBox ID="ParamsLinkBox1" runat="server" ShowTR_CompareTo="true" ShowTR_Group="true" ShowTR_STYP="true" /></td></tr>
    ...
    <tr>
        ...
        <SPAN class="text"><br>
        Major changes in WI student enrollment and attendance collections were implemented in 2004-05 so these data may not be comprehensive.  2004-05 ratios and
		percents using enrollment and attendance data should be interpreted with caution.
		<a href="javascript:popup('http://dpi.wi.gov/spr/discip_q&a.html')" onClick="setCookie(question, url)">[More]</a>
        </SPAN></td>
    </tr>    
    </asp:Panel>
          <tr>
