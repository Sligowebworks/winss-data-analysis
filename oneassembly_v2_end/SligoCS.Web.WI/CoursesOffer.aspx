...
<table style="padding:0px 0px 0px 0px; width:400px;">
    <tr><td><uc2:ParamsLinkBox ID="ParamsLinkBox1" runat="server" ShowTR_CompareTo="true" ShowTR_Group="false" ShowTR_STYP="false" ShowTR_WMAS="true" />
   </td>
    </tr>
    <tr>
        <td>
    ...
    <!--no graph-->
          <tr>
        <td>
            <cc1:SligoDataGrid ID="SligoDataGrid2" runat="server" AutoGenerateColumns="true" OnRowDataBound="SligoDataGrid2_RowDataBound" > 
                                <Columns>
