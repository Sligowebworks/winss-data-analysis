...
<cc1:HyperLinkPlus ID="linkCourseTypeIDIB" runat="server" ParamName="CourseTypeID" ParamValue="6">International Baccalaureate</cc1:HyperLinkPlus>
            ...
            <sli:NavigationLinkRow ID="nlrSubject" runat="server">
                ...
                <NavigationLinks>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus3" runat="server" ParamName="Subj" ParamValue="AP">English Language Arts</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus4" runat="server" ParamName="Subj" ParamValue="AP">Mathematics</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus5" runat="server" ParamName="Subj" ParamValue="AP">Science</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus6" runat="server" ParamName="Subj" ParamValue="AP">Social Studies</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus7" runat="server" ParamName="Subj" ParamValue="AP">Art and Design</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus8" runat="server" ParamName="Subj" ParamValue="AP">World Languages</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus9" runat="server" ParamName="Subj" ParamValue="AP">Music</cc1:HyperLinkPlus>
                     <cc1:HyperLinkPlus ID="HyperLinkPlus10" runat="server" ParamName="Subj" ParamValue="AP">Other</cc1:HyperLinkPlus>
                </NavigationLinks>
            </sli:NavigationLinkRow>
    ...
    <!--no graph-->
          <tr>
        <td>
            <slx:SligoDataGrid ID="SligoDataGrid2" runat="server" AutoGenerateColumns="true" OnRowDataBound="SligoDataGrid2_RowDataBound" > 
                                <Columns>
