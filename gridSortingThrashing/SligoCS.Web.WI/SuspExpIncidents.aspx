    ...
    <tr>
        ...
        <sli:NavSchoolType ID="nlrSTYP" runat="server" />
         <sli:NavigationLinkRow ID="nlrShow" runat="server">
                ...
                <NavigationLinks>
                   <cc1:HyperLinkPlus ID="HyperLinkPlus6" runat="server" ParamName="Show" ParamValue="Inc">Incident Rate</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus7" runat="server" ParamName="Show" ParamValue="Dis">Disciplinary Consequences</cc1:HyperLinkPlus>
                </NavigationLinks>
         </sli:NavigationLinkRow>
        <sli:NavigationLinkRow ID="NavigationLinkRow1" runat="server">
                <RowLabel>Type:</RowLabel> 
                <NavigationLinks>
                   <cc1:HyperLinkPlus ID="HyperLinkPlus8" runat="server" ParamName="Type" ParamValue="Inc">Weapon/Drug Related</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus9" runat="server" ParamName="Type"  ParamValue="Dis">Not Weapon/Drug Related</cc1:HyperLinkPlus>
                </NavigationLinks>
         </sli:NavigationLinkRow> 
        <sli:NavigationLinkRow ID="nlrVwBy" runat="server">
            ...
            <NavigationLinks>
                ...
                <cc1:HyperLinkPlus ID="HyperLinkPlus5" runat="server" Enabled ="false" ParamName="VwBy" ParamValue="Gr">Disability</cc1:HyperLinkPlus>
            </NavigationLinks>
        </sli:NavigationLinkRow>
        <sli:NavCompareTo ID="nlrCompareTo" runat="server" /></td>
    </tr>
