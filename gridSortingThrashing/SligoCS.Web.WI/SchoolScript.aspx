...
<!--//This is the show school lins for County (Click 
    ...
    <slx:SligoDataGrid ID="SligoDataGrid3"  runat="server" AutoGenerateColumns="False" ShowSuperHeader="true" BorderStyle="None" CellSpacing="0" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" ShowHeader="true" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left">
     <Columns >
        <asp:BoundField DataField="CountyName" HeaderText="COUNTY" ItemStyle-HorizontalAlign="Left">     
        </asp:BoundField>
...
<!-- Schools Display 2-->   
    <slx:SligoDataGrid ID="SligoDataGrid4" runat="server" AutoGenerateColumns="False" ShowSuperHeader="true" BorderStyle="None" CellSpacing="0" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" ShowHeader="true" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left">
     <Columns >
        <asp:BoundField DataField="CountyName" HeaderText="COUNTY" ItemStyle-HorizontalAlign="Left">
        </asp:BoundField>
...
<!--//CESA -->
    <slx:SligoDataGrid ID="SligoDataGrid5"  runat="server" AutoGenerateColumns="False" ShowSuperHeader="true" BorderStyle="None" CellSpacing="0" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" ShowHeader="true" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left">
     <Columns >
        <asp:BoundField DataField="CountyName" HeaderText="COUNTY">     
