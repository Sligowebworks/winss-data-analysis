<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="DisabilEnroll.aspx.cs" Inherits="SligoCS.Web.WI.DisabilEnroll" %>
...
<table style="padding:0px 0px 0px 0px; width:400px;">
    ...
    <sli:NavigationLinkRow ID="nlrDisabil" runat="server">
        ...
        <NavigationLinks>
            <cc1:HyperLinkPlus ID="HyperLinkPlus1" runat="server" ParamName="Disabil" ParamValue="AP">All Primary Disabilities</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus2" runat="server" ParamName="Disabil" ParamValue="AP">Cognitive Disability (CD)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus3" runat="server" ParamName="Disabil" ParamValue="AP">Emotional Behavior Disability (EBD)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus4" runat="server" ParamName="Disabil" ParamValue="AP">Specific Learning Disability (LD)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus5" runat="server" ParamName="Disabil" ParamValue="AP">Speech or Language Impairment (SL)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus6" runat="server" ParamName="Disabil" ParamValue="AP">Autism (A)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus7" runat="server" ParamName="Disabil" ParamValue="AP">Deaf-Blind (DB)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus8" runat="server" ParamName="Disabil" ParamValue="AP">Hearing Impairment (HI)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus9" runat="server" ParamName="Disabil" ParamValue="AP">Other Health Impairment (OHI)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus10" runat="server" ParamName="Disabil" ParamValue="AP">Orthopedic Impairment (OI)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus11" runat="server" ParamName="Disabil" ParamValue="AP">Significant Developmental Delay (SDD)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus12" runat="server" ParamName="Disabil" ParamValue="AP">Traumatic Brain Injury (TBI)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus13" runat="server" ParamName="Disabil" ParamValue="AP">Visual Impairment (VI)</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus14" runat="server" ParamName="Disabil" ParamValue="AP">Combined (SWD)</cc1:HyperLinkPlus>
        </NavigationLinks>
    </sli:NavigationLinkRow>
    <sli:NavigationLinkRow ID="VwBy" runat="server">
        <RowLabel>View By:</RowLabel>
        <NavigationLinks>
            <cc1:HyperLinkPlus ID="HyperLinkPlus15" runat="server" ParamName="VwBy" ParamValue="AP">All Students</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus16" runat="server" Enabled="false">Gender</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus17" runat="server" Enabled="false">Race/Ethnicity</cc1:HyperLinkPlus>
            <cc1:HyperLinkPlus ID="HyperLinkPlus18" runat="server" Enabled="false">Race/Ethnicity &amp; Gender</cc1:HyperLinkPlus>
        </NavigationLinks>
    </sli:NavigationLinkRow>
