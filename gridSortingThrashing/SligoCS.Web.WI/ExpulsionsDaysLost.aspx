<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="ExpulsionsDaysLost.aspx.cs" Inherits="SligoCS.Web.WI.ExpulsionsDaysLost" Title="What percentage of days were lost due to suspensions and expulsions?" %>
    ...
    <tr>
        <td>         <sli:NavSchoolType ID="nlrSTYP" runat="server" />
         <sli:NavigationLinkRow ID="nlrShow" runat="server">
                ...
                <NavigationLinks>
                   <cc1:HyperLinkPlus ID="HyperLinkPlus6" runat="server" UrlFile="SuspensionsDaysLost.aspx" ParamName="Show" ParamValue="Su">Suspensions</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus7" runat="server" UrlFile="ExpulsionsDaysLost.aspx" ParamName="Show" ParamValue="Ex">Expulsions</cc1:HyperLinkPlus>
                </NavigationLinks>
...
Major changes in WI student enrollment and attendance collections were implemented in 2004-05 so these data may not be comprehensive. 2004-05 ratios and percents using enrollment and attendance data should be interpreted with caution. <a href="javascript:popup('http://dpi.wi.gov/spr/discip_q&a.html')" onClick="setCookie(question, url)">[More]</a>
        ...
        <tr>
            <td>
                ...
                <cc1:MergeColumn DataField="Possible Days Attendance" 
                        HeaderText="Possible Days Attendance" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
                ...
                <cc1:MergeColumn DataField="Number of Days Expelled" 
                        HeaderText="Number of Days Expelled" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
                ...
                <cc1:MergeColumn DataField="Percent of Days Expelled" 
                        HeaderText="Percent of Days Expelled" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
