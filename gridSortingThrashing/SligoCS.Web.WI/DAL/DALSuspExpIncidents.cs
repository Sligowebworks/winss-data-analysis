...
namespace SligoCS.DAL.WI
{
    ...
    {
        /// <summary>
        /// Implementor.  This function queries the v_SuspensionsDis, with several optional stickyParameters.
        /// </summary>
        /// <returns></returns>
        public v_SuspExpIncidents GetSuspExpIncidentsData(List<int> raceCode,
            List<int> sexCode,
            ...
            List<string> orderBy)
        {
            ...
            sb.Append("select * from v_SuspExpIncidents where");
            ...
            base.GetDS(ds, sb.ToString(), ds._v_SuspExpIncidents.TableName);
            return ds;
        }
    }
}
