...
<table style="padding:0px 0px 0px 0px; width:400px;">
    ...
    <sli:NavSchoolType ID="nlrSTYP" runat="server" />
        <sli:NavigationLinkRow ID="nlrVwBy" runat="server">
            ...
            <NavigationLinks>
                <cc1:HyperLinkPlus ID="HyperLinkPlus1" runat="server" ParamName="Show" ParamValue="AP">Extra/Co-curricular Activities</cc1:HyperLinkPlus>
                <cc1:HyperLinkPlus ID="HyperLinkPlus2" runat="server" ParamName="Show" ParamValue="AP">Community Activities</cc1:HyperLinkPlus>
            </NavigationLinks>
