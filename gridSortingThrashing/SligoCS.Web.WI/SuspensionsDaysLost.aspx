...
Major changes in WI student enrollment and attendance collections were implemented in 2004-05 so these data may not be comprehensive. 2004-05 ratios and percents using enrollment and attendance data should be interpreted with caution. <a href="javascript:popup('http://dpi.wi.gov/spr/discip_q&a.html')" onClick="setCookie(question, url)">[More]</a>
        ...
        <tr>
            <td>
                ...
                <cc1:MergeColumn DataField="Number of Days Suspended" 
                        HeaderText="Number of Days Suspended" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
                ...
                <cc1:MergeColumn DataField="Percent of Days Suspended" 
                        HeaderText="Percent of Days Suspended" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
