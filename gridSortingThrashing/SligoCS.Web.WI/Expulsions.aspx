<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="Expulsions.aspx.cs" Inherits="SligoCS.Web.WI.Expulsions" Title="What percentage of students were suspended or expelled?" %>
...
<table style="padding:0px 0px 0px 0px; width:400px;">
    <tr>
        ...
        <sli:NavigationLinkRow ID="nlrVwBy" runat="server">
            ...
            <NavigationLinks>
                <cc1:HyperLinkPlus ID="HyperLinkPlus1" runat="server" ParamName="VwBy" ParamValue="As">All Students</cc1:HyperLinkPlus>
                <cc1:HyperLinkPlus ID="HyperLinkPlus2" runat="server" ParamName="VwBy" ParamValue="Gn">Gender</cc1:HyperLinkPlus>
                <cc1:HyperLinkPlus ID="HyperLinkPlus3" runat="server" ParamName="VwBy" ParamValue="Re">Race/Ethnicity</cc1:HyperLinkPlus>
                <cc1:HyperLinkPlus ID="HyperLinkPlus4" runat="server" ParamName="VwBy" ParamValue="Gr">Grade</cc1:HyperLinkPlus>
                <cc1:HyperLinkPlus ID="HyperLinkPlus5" runat="server" ParamName="VwBy" ParamValue="Di">Disability</cc1:HyperLinkPlus>
            </NavigationLinks>
        </sli:NavigationLinkRow>
	...
	Major changes in WI discipline data collection systems were implemented in 2006-07. WINSS data about suspensions and expulsions were included in this transition year collection and are not comprehensive so should be interpreted with caution. See other <a href="javascript:popup('http://dpi.wi.gov/spr/discip_q&a.html')" onClick="setCookie(question, url)">cautions</a> and information about discipline data on WINSS.
        ...
        <tr>
            <td>
                ...
                <cc1:MergeColumn DataField="Number of Students Expelled" 
                        HeaderText="Number of Students Expelled" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
                ...
                <cc1:MergeColumn DataField="Expulsion Percent" 
                        HeaderText="Expulsion Percent" EnableMerge="false"
                    HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" 
                    HeaderStyle-BorderStyle="Double"
                    ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="3px" 
                    ItemStyle-BorderStyle="Double">
