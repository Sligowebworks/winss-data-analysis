    ...
    <tr>
        <td>
            <sli:NavigationLinkRow ID="nlrShow" runat="server">
                <RowLabel>Show Ration of: </RowLabel>
                <NavigationLinks>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus1" runat="server" ParamName="Show" ParamValue="AP">Students to Staff</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus2" runat="server" ParamName="Show" ParamValue="AP">Staff to Students</cc1:HyperLinkPlus>
                </NavigationLinks>
