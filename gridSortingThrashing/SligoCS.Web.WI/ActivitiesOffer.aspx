<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="ActivitiesOffer.aspx.cs" Inherits="SligoCS.Web.WI.ActivitiesOffer" %>
...
<tr><td>
        ...
        <sli:NavigationLinkRow ID="nlrShow" runat="server">
            ...
            <NavigationLinks>
                <cc1:HyperLinkPlus ID="HyperLinkPlus1" runat="server" ParamName="Show" ParamValue="1">Extra/Co-curricular Activities</cc1:HyperLinkPlus>
                 <cc1:HyperLinkPlus ID="HyperLinkPlus2" runat="server" ParamName="Show" ParamValue="1">Community Activities</cc1:HyperLinkPlus>
            </NavigationLinks>
