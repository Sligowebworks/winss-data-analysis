...
<a href="javascript:popup('https://www2.dpi.state.wi.us/DistrictProfile/Pages/DistrictProfile.aspx?year=2008&DistrictID=<% = DistrictCd %>')" onClick="setCookie(question, url)">
