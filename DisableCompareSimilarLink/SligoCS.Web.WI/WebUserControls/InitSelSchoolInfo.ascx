...
<tr><td style="width: 185px">&nbsp;</td></tr>
<tr><td style="width: 185px">
<%--<a href="<%= Request.ApplicationPath%>/questions.aspx?fullkey=ZZZZZZZZZZZZ&DN=None+Chosen&SN=None+Chosen&TYPECODE=0&OrgLevel=ST" class="lightblue"><b>STATE Level Data</b></a>--%>
<asp:HyperLink ID="STATELevelData" runat="server" CssClass="lightblue" Text="STATE Level Data" Font-Bold="true" />
</td></tr>
<tr><td style="width: 185px">&nbsp;</td></tr>
<tr><td style="width: 185px">
<a href="http://data.dpi.state.wi.us/data/DataDownload/frm.SelectDataSet.asp" class="lightblue" target="DownloadOptions">Download Options</a>&nbsp;|&nbsp;<a href="http://dpi.wi.gov/sig/usetips_data.html" target="help" onclick="popup('http://dpi.wi.gov/sig/usetips_data.html','help');" class="lightblue">Tips</a>
</td></tr>
<tr><td style="width: 185px">&nbsp;</td></tr>
<tr><td style="width: 185px">
