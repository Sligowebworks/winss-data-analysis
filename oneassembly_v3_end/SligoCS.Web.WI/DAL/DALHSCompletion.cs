...
namespace SligoCS.DAL.WI
{
    public class DALHSCompletion : DALWIBase
    {
        ...
        public v_HSCWWoDisSchoolDistState GetHSCompletionData(List<int> raceCode,
            List<int> sexCode,
            ...
            List<string> orderBy)
        {
            ...
            sb.Append("select * from v_HSCWWoDisSchoolDistState where ");
            ...
            base.GetDS(ds, sb.ToString(), ds._v_HSCWWoDisSchoolDistState.TableName);
            return ds;
        }
