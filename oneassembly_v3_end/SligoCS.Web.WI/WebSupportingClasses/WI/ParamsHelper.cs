...
namespace SligoCS.Web.Base.WebSupportingClasses.WI
{
    ...
    public class ParamsHelper
    {
        ...
        public static string GetQueryString(StickyParameter stickyParameter, string overrideParamName, string overrideParamVal)
        {
            ...
            if (HttpContext.Current.Session[SligoCS.BLL.WI.Constants.CACHED_QUERY_STRING] != null &&
                HttpContext.Current.Session[SligoCS.BLL.WI.Constants.CACHED_QUERY_STRING].ToString() != String.Empty)
            {
                cachedQueryString = HttpContext.Current.Session[SligoCS.BLL.WI.Constants.CACHED_QUERY_STRING].ToString();
            }
