...
<table style="padding:0px 0px 0px 0px; width:400px;">
    <tr>
      ...
      <tr>
        <td align="right"><p> Go to: <slb:HyperLinkPlus ID="gotocurrent" runat="server" ParamName="CompareTo" ParamValue="CURRENTONLY" Prefix="">Nov 2012</slb:HyperLinkPlus>** Test Results</p></td>
        </tr> 
       </asp:Panel>
    ...
    <tr>
        <td>
            <Graph:GraphBarChart ID="barChart" runat="server"></Graph:GraphBarChart>
				...
				<br />** Due to cut score adjustments in 2002 and <a href="javascript:popup('http://oea.dpi.wi.gov/oea_wkce-crtcuts')">2012</a>, proficiency data are not comparable over time.  WINSS reading and math proficiency data through Nov 2011 are not comparable to more recent data. WINSS proficiency data (all subjects) for Nov 2002 through Nov 2011 are not comparable to earlier years.  Some subject area tests are given only at grades 4, 8, and 10. 
     ...
     <tr>
        ...
        <div class="text"><A href=javascript:popup('http://dpi.wi.gov/oea_amo') onClick='setCookie(question, url)'>View comparison to annual measurable objectives</A></div>
            ...
            <div class="text">
	            <a href="javascript:popup('http://oea.dpi.wi.gov/oea_naep')" onclick="setCookie(question, url)">National Assessment of Educational Progress – Wisconsin Results</a></div>
            <div class="text"><br />
