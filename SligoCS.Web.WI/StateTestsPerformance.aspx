...
<table style="padding:0px 0px 0px 0px; width:400px;">
    ...
    <tr>
        <td>
			...
			<br /> Due to <a href="javascript:popup('http://www.dpi.wi.gov/spr_demog_q&a#race')" onClick="setCookie(question, url)">2010-11 race/ethnicity reporting</a> changes, pre- and post-2010-11 data by race/ethnicity may not be comparable. 
