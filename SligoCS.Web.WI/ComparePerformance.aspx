...
<%@ Register Src="WebUserControls/BottomLinkCompareAMO.ascx" TagName="BottomLinkCompareAMO" TagPrefix="uc10" %>
    ...
    <tr>
      ...
      <tr>
        ...
        <td>
            ...
            <uc10:BottomLinkCompareAMO id="BottomLinkCompareAMO" runat="server"/>
