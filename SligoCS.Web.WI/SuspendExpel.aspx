<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="SuspendExpel.aspx.cs" Inherits="SligoCS.Web.WI.SuspendExpel" %>
...
<table style="padding:0px 0px 0px 0px; width:400px;">
    <tr><td><uc2:ParamsLinkBox ID="ParamsLinkBox1" runat="server" ShowTR_CompareTo="true" ShowTR_Group="true" ShowTR_STYP="true" />
    </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td> <Graph:GraphBarChart ID="barChart" runat="server"></Graph:GraphBarChart>
        <SPAN class="text"><br>
	Major changes in WI discipline data collection systems were implemented in 2006-07. WINSS data about suspensions and expulsions were included in this 
		transition year collection and are not comprehensive so should be interpreted with caution. See other 
		<a href="javascript:popup('http://dpi.wi.gov/spr/discip_q&a.html')" onClick="setCookie(question, url)">cautions</a> and information about 
		discipline data on 	WINSS.
	</SPAN>
        </td>
    </tr>    
    </asp:Panel>
