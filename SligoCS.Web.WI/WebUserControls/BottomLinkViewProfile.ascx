...
<a href="javascript:popup('https://apps4.dpi.wi.gov/DistrictProfile/Pages/DistrictProfile.aspx?year=<%= globals.CurrentYear %>&DistrictID=<% = DistrictCd %>')" onClick="setCookie(question, url)">
