    ...
    <tr>
        <td>
         ...
         <sli:NavigationLinkRow ID="nlrShow" runat="server">
                ...
                <NavigationLinks>
                   <cc1:HyperLinkPlus ID="HyperLinkPlus6" runat="server" UrlFile="SuspensionsDaysLost.aspx" Selected="false">Suspensions</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus7" runat="server" UrlFile="ExpulsionsDaysLost.aspx" Selected="true">Expulsions</cc1:HyperLinkPlus>
                </NavigationLinks>
...
Major changes in WI student enrollment and attendance collections were implemented in 2004-05 so these data may not be comprehensive. 2004-05 ratios and percents using enrollment and attendance data should be interpreted with caution. <a href="javascript:popup('http://spr.dpi.wi.gov/spr_discip_q%26amp%3Ba')" onClick="setCookie(question, url)">[More]</a>
        ...
        <tr>
            <td>
                ...
                <slx:WinssDataGridColumn DataField="Number of Days Expelled" FormatString="#,##0.#" />
                <slx:WinssDataGridColumn DataField="Percent of Days Expelled"  FormatString="#,##0.0%" />
                </Columns>
                </slx:WinssDataGrid>
            </td>
        </tr>
