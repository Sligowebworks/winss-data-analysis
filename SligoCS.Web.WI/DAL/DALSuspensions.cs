...
namespace SligoCS.DAL.WI
{
    public class DALSuspensions : DALWIBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public v_SuspensionsDis GetSuspensionsDisData(List<int> raceCode,
            List<int> sexCode,
            ...
            List<string> orderBy)
        {
            ...
            sb.Append("select * from v_SuspensionsDis where");
            ...
            base.GetDS(ds, sb.ToString(), ds._v_SuspensionsDis.TableName);
            return ds;
        }
    }
}
