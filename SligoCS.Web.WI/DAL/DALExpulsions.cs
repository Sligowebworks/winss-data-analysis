...
{
    public class DALExpulsions : DALWIBase
    {
        /// <summary>
        /// Implementor.  This function queries the v_ExplusionsDis, with several optional stickyParameters.
        /// </summary>
        /// <returns></returns>
        // jdj: note "explusions", not "Expulsions" below
        public v_ExplusionsDis GetExpulsionsDisData(List<int> raceCode,
            List<int> sexCode,
            ...
            List<string> orderBy)
        {
            ...
            sb.Append("select * from v_ExpulsionsDis where");
            ...
            base.GetDS(ds, sb.ToString(), ds.v_ExpulsionsDis.TableName);
            return ds;
        }
    }
}
