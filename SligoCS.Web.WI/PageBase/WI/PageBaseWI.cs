...
namespace SligoCS.Web.Base.PageBase.WI
{
    ...
    public abstract class PageBaseWI: PageBaseSligo
    {
        ...
        protected delegate Boolean DelegateTest(Control ctrl);
        protected delegate void ControlDelegate(Control arg);

        protected void visitControls(ControlCollection list, DelegateTest isTarget, ControlDelegate visit)
        {  
        ...
        public void setNavigationlinkURL(Control theCtrl)
        {
            ...
            if (StickyParameter != null)
            {
                ...
                string qstring = ParamsHelper.GetQueryString(StickyParameter, theLink.ParamName, theLink.ParamValue);
                string url = string.Format("{0}{1}", Request.Url.LocalPath, qstring);
                ...
                System.Reflection.PropertyInfo propertyInfo = StickyParameter.GetType().
                    GetProperty(theLink.ParamName,
                                System.Reflection.BindingFlags.GetProperty
                                | System.Reflection.BindingFlags.Public
                                | System.Reflection.BindingFlags.Instance
                                | System.Reflection.BindingFlags.IgnoreCase);
                if (propertyInfo != null && propertyInfo.GetValue(StickyParameter, null) != null)
                {
                    theLink.Selected = (theLink.ParamValue == propertyInfo.GetValue(StickyParameter, null).ToString());
                }
            }
        }
    }
