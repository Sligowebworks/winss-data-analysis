    ...
    <tr>
        <td>
            ...
            <Graph:GraphHorizBarChart ID="hrzBarChart" runat="server" />
            	<SPAN class="text"><br>
Major changes in WI data collection systems were implemented in 2004-05. 2004-05 enrollment data were included in this transition year collection and are not comprehensive so should be interpreted with caution. <a href="javascript:popup('http://www.dpi.wi.gov/spr/demog_q&a.html')" onClick="setCookie(question, url)">[More]</a>
	</SPAN>
        </td>
    </tr>    
    </asp:Panel>
      ...
      <tr>
        <td>
            <slx:WinssDataGrid ID="EnrollmentDataGrid" runat="server" >
                ...
                <slx:WinssDatagridColumn DataField="BlackPercent" HeaderText="% Black Not Hisp" FormatString="#,##0.0%" />  
                <slx:WinssDatagridColumn DataField="HispPercent" HeaderText="% Hispanic" FormatString="#,##0.0%" /> 
                <slx:WinssDatagridColumn DataField="PacIPercent" HeaderText="% Pacific Islander" FormatString="#,##0.0%" /> 
                <slx:WinssDatagridColumn DataField="WhitePercent" HeaderText="% White Not Hisp" FormatString="#,##0.0%" /> 
                <slx:WinssDatagridColumn DataField="TwoPercent" HeaderText="% Two+ Races" FormatString="#,##0.0%" />
                <slx:WinssDatagridColumn DataField="CombPercent" HeaderText="% Comb" FormatString="#,##0.0%" />  
