<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="ActivitiesOffer.aspx.cs" Inherits="SligoCS.Web.WI.ActivitiesOffer" Title="Activities Offered" %>
...
<tr><td>
        ...
        <td>
            <slx:WinssDataGrid ID="ActivitiesDataGrid" runat="server" >
                <Columns>      
                    ...
                    <slx:WinssDatagridColumn DataField="Offerings Per School (Average)"  FormatString="#,##0.0##" />
                </Columns>
                </slx:WinssDataGrid>
        </td>
    </tr>
    <tr>
        <td>
            ...
            <SPAN class="text">
	            <p><a href="javascript:popup('http://dpi.wi.gov/spr/activi_use.html')" onClick="setCookie(question, url)">What are some questions to consider when reviewing these graphs?</a></p>
            </SPAN>
        </td>
    </tr>
 </table>
