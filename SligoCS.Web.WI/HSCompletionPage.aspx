...
<table>
    ...
    <tr>
        <td>
	<span class="text">
	Graduation (regular diploma) and completion rate reporting changed in 2003-04 and 2009-10.  2003-04 was a year of transition to a new student data collection, and as a result 2003-04 legacy-rate data may not be comprehensive.   Four-year rates were first available in 2009-10.  <a href="javascript:popup('http://www.dpi.wi.gov/spr/grad_q&a.html')" onclick="setCookie(question, url)">[More]</a>  See formulas for calculating <a href="javascript:popup('http://www.dpi.wi.gov/spr/grad_q&a.html#rate')" onclick="setCookie(question, url)">rates</a>.
	</span>
        </td>
    </tr>
    <tr>
