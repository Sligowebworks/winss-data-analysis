...
<br /><p><span class="text">**Total Expected to Complete High School is a count of students who were expected to complete high school in the year indicated whether or not the students actually did.  This total includes actual high school completers, cohort dropouts, and noncompleters who reached the maximum age associated with the constitutional right to a free public education. <a href="javascript:popup('http://dpi.wi.gov/winss/perfacademic_glossary.html#expected_completer')" onclick="setCookie(question, url)">[More]</a></span></p>
