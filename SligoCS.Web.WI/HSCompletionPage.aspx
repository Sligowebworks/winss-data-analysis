...
<table>
    ...
    <tr>
        <td>
	<span class="text">
	See formulas for calculating <a href="javascript:popup('http://www.dpi.wi.gov/spr/grad_q&a.html#rate')" onclick="setCookie(question, url)">rates</a>.  Four-year rates were ﬁrst available in 2009-10.
In general, students are counted in the district/school <a href="javascript:popup('http://dpi.wi.gov/spr/grad_q&a.html#mobility')">where last enrolled</a>.
District/school rates may include some high school students in residential facilities
(e.g. a county jail, county secure detention, mental health center, hospital,
group/foster home, CBRF, etc) located in the district. Due to <a href="javascript:popup('http://dpi.wi.gov
/spr/demog_q&a.html#race')">2010-11 race/ethnicity reporting changes</a>, pre- and post-2010-11 completion rates by
race/ethnicity may not be comparable. Also note that automated processes to <a href="javascript:popup('http://www.dpi.wi.gov/lbstat/priv_more.html')">protect student privacy</a> were modiﬁed in spring 2012. <a href="javascript:popup('http://www.dpi.wi.gov/spr/grad_q&a.html')">[More]</a> 
