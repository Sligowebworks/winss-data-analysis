...
<table>
    ...
    <tr>
        <td>
	<span class="text">
	Graduation (regular diploma) and completion rate reporting changed in 2003-04 and 2009-10. 2003-04 was a year of transition to a new student data collection, and as a result 2003-04 legacy-rate data may not be comprehensive. Four-year  rates were first available in 2009-10.  See formulas for calculating <a href="javascript:popup('http://www.dpi.wi.gov/spr_grad_q&a#rate')" onclick="setCookie(question, url)">rates</a>.  Due to <a href="javascript:popup('http://spr.dpi.wi.gov/spr_demog_q&a#race')">2010-11 race/ethnicity reporting changes</a>, pre- and post-2010-11 completion rates by race/ethnicity may not be comparable. Also note that automated processes to <a href="javascript:popup('http://www.dpi.wi.gov/lbstat_priv_more')" onclick="setCookie(question, url)">protect student privacy</a> were modified in spring 2012. <a href="javascript:popup('http://www.dpi.wi.gov/spr_grad_q&a')" onclick="setCookie(question, url)">[More]</a>  
	</span>
        </td>
    </tr>
    <tr>
