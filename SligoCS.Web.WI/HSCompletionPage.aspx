...
<br /><p><span class="text">**<a href="javascript:popup('http://wise.dpi.wi.gov/wisedash_glossary#expected_completer')" onclick="setCookie(question, url)">Total Expected to Complete High School</a> is the denominator used to calculate graduation and completion rates.   For the four-year rates, this total is the count of students in the <a href="javascript:popup('http://wise.dpi.wi.gov/wisedash_glossary#adjusted_cohort')" onclick="setCookie(question, url)">adjusted 4-year cohort</a> for the graduating class. For the legacy rates, this total is the sum of actual high school completers, <a href="javascript:popup('http://wise.dpi.wi.gov/wisedash_glossary#cohort_dropout')" onclick="setCookie(question, url)">cohort dropouts</a>, plus noncompleters who reached the <a href="javascript:popup('http://wise.dpi.wi.gov/wisedash_glossary#maximum_age')" onclick="setCookie(question, url)">maximum age</a> associated with the right to a free public education.   
</span></p>
