...
{
    public class WinssDataGrid : GridView, INamingContainer
    {
        ...
        public PlaceHolder NoDataMessagePlaceHolder = new PlaceHolder();
        public Label NoDataMessage = new Label();
        ...
        /// <summary>
        /// creates a table cell, "td" and adds it to the passed TableTow
        /// </summary>
        /// <param name="tr">row to add the cell to</param>
        /// <param name="text">text of the new cell</param>
        /// <param name="colSpan"></param>
        public static void AddTableCell(TableRow tr, string text, int colSpan)
        {
            TableCell cell = new TableCell();
            cell.Text = text;
        ...
        public override object DataSource
        {
            ...
            set
            {
                ...
                if (OrderBy == null) //not set, so use default:
                    OrderBy = 
