        ...
        <sli:NavigationLinkRow ID="nlrShow" runat="server">
         ...
         <sli:NavigationLinkRow ID="NavigationLinkRow2" runat="server">
                ...
                <NavigationLinks>
                 ...
                 <cc1:HyperLinkPlus ID="linkTQRelateToNativeAm" runat="server" ParamName="TQRelateTo" ParamValue="Ntv">&#37; Am Indian</cc1:HyperLinkPlus>
                 ...
                 <cc1:HyperLinkPlus ID="linkTQRelateToPacific" runat="server" ParamName="TQRelateTo" ParamValue="Pac">&#37; Pacific Islander</cc1:HyperLinkPlus>
                 <cc1:HyperLinkPlus ID="linkTQRelateToWhite" runat= "server" ParamName="TQRelateTo" ParamValue="Wht">&#37; White</cc1:HyperLinkPlus>
                 <cc1:HyperLinkPlus ID="linkTQRelateToTwoPlusRaces" runat="server" ParamName="TQRelateTo" ParamValue="2OrMore">&#37; Two+ Races</cc1:HyperLinkPlus>
                </NavigationLinks>
         </sli:NavigationLinkRow>
