    ...
    <tr>
        ...
        <sli:NavigationLinkRow ID="nlrShow" runat="server">
         ...
         <sli:NavigationLinkRow ID="NavigationLinkRow2" runat="server">
                ...
                <NavigationLinks>
                   <cc1:HyperLinkPlus ID="linkTQRelateToSpending" runat="server" ParamName="TQRelateTo" ParamValue="Spending">District Spending</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToDistrictSize" runat="server" ParamName="TQRelateTo" ParamValue="DistSize">District Size</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToSchoolSize" runat="server" ParamName="TQRelateTo" ParamValue="SchoolSize">School Size</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToEconomicStatus" runat="server" ParamName="TQRelateTo" ParamValue="EconomicStatus">&#37; Economically Disadvantaged</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToEnglishProficiency" runat="server" ParamName="TQRelateTo" ParamValue="EnglishProficiency">&#37; Limited English Proficient</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToDisability" runat="server" ParamName="TQRelateTo" ParamValue="Disability">&#37; Students with Disabilities</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToNativeAm" runat="server" ParamName="TQRelateTo" ParamValue="Native">&#37; Am Indian</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToAsian" runat="server" ParamName="TQRelateTo" ParamValue="Asian">&#37; Asian</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToBlack" runat="server" ParamName="TQRelateTo" ParamValue="Black">&#37; Black</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToHispanic" runat="server" ParamName="TQRelateTo" ParamValue="Hispanic">&#37; Hispanic</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="linkTQRelateToWhite" runat="server" ParamName="TQRelateTo" ParamValue="White">&#37; White</cc1:HyperLinkPlus>
                </NavigationLinks>
         </sli:NavigationLinkRow>
