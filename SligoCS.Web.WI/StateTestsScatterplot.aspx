...
You may click on the "Back" button of your browser to select another type of data, or click on "change school" to select a different school. If you feel you have received this page in error, please email winss@dpi.wi.gov.</td>
    </tr>
    </asp:Panel>
    <tr>
    <td>
        ...
        <span class="text">
			...
			<br />Due to 2010-11 race/ethnicity reporting changes, pre- and post-2010-11 data by race/ethncity may not be comparable. <a href="javascript:popup('http://www.dpi.wi.gov/spr/demog_q&a.html')" onClick="setCookie(question, url)">[More]</a>
