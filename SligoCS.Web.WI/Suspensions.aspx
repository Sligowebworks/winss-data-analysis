<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="Suspensions.aspx.cs" Inherits="SligoCS.Web.WI.Suspensions" Title="Suspensions" %>
...
<table style="padding:0px 0px 0px 0px; width:400px;">
    <tr>
        <td>
         ...
         <sli:NavigationLinkRow ID="nlrShow" runat="server">
                ...
                <NavigationLinks>
                   <cc1:HyperLinkPlus ID="HyperLinkPlus6" runat="server" UrlFile="Suspensions.aspx" Selected="true" >Suspensions</cc1:HyperLinkPlus>
                    <cc1:HyperLinkPlus ID="HyperLinkPlus7" runat="server" UrlFile="Expulsions.aspx" Selected="false">Expulsions</cc1:HyperLinkPlus>
                </NavigationLinks>
    ...
    <asp:Panel ID="GraphPanel" ContentPlaceHolderID="GraphPlaceHolder"  runat="server">    
    <tr>
        <td>
	...
	Major changes in WI discipline data collection systems were implemented in 2006-07. WINSS data about suspensions and expulsions were included in this transition year collection and are not comprehensive so should be interpreted with caution. See other <a href="javascript:popup('http://dpi.wi.gov/spr/discip_q&a.html')" onClick="setCookie(question, url)">cautions</a> and information about discipline data on WINSS.
        ...
        <tr>
            <td>
                ...
                <Columns>                                        
                <slx:WinssDataGridColumn DataField="YearFormatted" MergeRows="true"  HeaderText="&nbsp;" />
                <slx:WinssDataGridColumn DataField="LinkedName" MergeRows="true"  HeaderText="&nbsp;" />
                <slx:WinssDataGridColumn DataField="District Name" MergeRows="true"  HeaderText="&nbsp;" />
                ...
                <slx:WinssDataGridColumn DataField="SchooltypeLabel" MergeRows="true"  HeaderText="&nbsp;" />
                <slx:WinssDataGridColumn DataField="RaceLabel" MergeRows="true"  HeaderText="&nbsp;"/>
                <slx:WinssDataGridColumn DataField="DisabilityLabel" MergeRows="true"  HeaderText="&nbsp;"/>
                <slx:WinssDataGridColumn DataField="SexLabel" MergeRows="true"  HeaderText="&nbsp;"/>
                <slx:WinssDataGridColumn DataField="GradeLabel"  MergeRows="true"  HeaderText="&nbsp;"/>
                <slx:WinssDataGridColumn DataField="Total Enrollment PreK-12" HeaderText="Total Fall Enrollment PreK-12**" FormatString="#,##0.###" />
                <slx:WinssDataGridColumn DataField="Number of Students Suspended" HeaderText="Number of Students Suspended" FormatString="#,##0.###" />
                <slx:WinssDataGridColumn DataField="Suspension Percent" HeaderText="Suspension Percent" FormatString="#,##0.00%" />
                </Columns>
                </slx:WinssDataGrid>
