<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="GridPage.aspx.cs" Inherits="SligoCS.Web.WI.GridPage" Title="Grid Demo" %>

<%@ Register Src="WebUserControls/ParamsLinkBox.ascx" TagName="ParamsLinkBox" TagPrefix="uc2" %>
<%@ Register Src="WebUserControls/SligoWIGraph.ascx" TagName="SligoWIGraph" TagPrefix="uc3" %>
...
<table>
    <tr>
     ...
     <tr>
        <td> <uc3:SligoWIGraph ID="SligoWIGraph1" runat="server" visible =true/> </td>
    </tr>
    <tr>
