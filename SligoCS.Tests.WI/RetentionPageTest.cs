...
namespace SligoCS.Tests.WI
{
    ...
    public class RetentionPageTest : BasePageTest
    {
        ...
        public override void Bug617_GetVisibleColumns()
        {
            ...
            //List<string> cols = retentionPage.GetVisibleColumns(ViewByGroup.AllStudentsFAY, OrgLevel.District, CompareToEnum.PRIORYEARS, SchoolType.AllTypes);
        ...
        public override void  Bug808_GraphTitles()
        {
            ...
            //    CompareToEnum.PRIORYEARS, SchoolType.AllTypes);
            ...
            //title = retentionPage.GetTitle("Rate of Retention", ViewByGroup.ELP, "Milwaukee", OrgLevel.District, new List<int>(), CompareToEnum.PRIORYEARS, SchoolType.AllTypes);
