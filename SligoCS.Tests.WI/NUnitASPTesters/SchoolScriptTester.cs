...
namespace SligoCS.Tests.WI.NUnitASPTesters
{
    ...
    public class SchoolScriptTester : BaseTester 
    {
        ...
        public void Bug874_SchoolScriptShouldPassParams()
        {
            ...
            ////check LOWGRADE and HIGHGRADE exist in StickyParameter and have Default values.
            //StickyParameter helper = new StickyParameter();
            //helper.LoadFromContext(stickyParameter);
