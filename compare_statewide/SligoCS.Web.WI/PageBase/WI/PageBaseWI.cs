...
//            throw new Exception(orderBy);
        ...
        /// <summary>
        /// Wraps the qs and generally represents user-input without derived application state.
