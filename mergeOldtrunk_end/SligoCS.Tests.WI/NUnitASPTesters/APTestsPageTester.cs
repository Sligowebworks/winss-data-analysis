...
namespace SligoCS.Tests.WI.NUnitASPTesters
{
    ...
    public class APTestsPageTester : BaseTester
    {
        ...
        public void Bug842_APTests_Columns()
        {
            ...
            List<string> cols = ap.GetVisibleColumns(SligoCS.BL.WI.ViewByGroup.AllStudentsFAY, SligoCS.BL.WI.OrgLevel.District, SligoCS.BL.WI.CompareTo.PRIORYEARS, SchoolType.AllTypes);
            ...
            cols = ap.GetVisibleColumns(SligoCS.BL.WI.ViewByGroup.AllStudentsFAY, SligoCS.BL.WI.OrgLevel.District, SligoCS.BL.WI.CompareTo.DISTSTATE, SchoolType.AllTypes);
            Assert.IsTrue(cols.Count == 7, "Expected 7 columns on AP Exams page.");
            ...
            cols = ap.GetVisibleColumns(SligoCS.BL.WI.ViewByGroup.RaceEthnicity, SligoCS.BL.WI.OrgLevel.District, SligoCS.BL.WI.CompareTo.DISTSTATE, SchoolType.AllTypes);
