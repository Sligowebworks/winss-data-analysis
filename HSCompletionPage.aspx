...
<table>
    ...
    <tr>
        <td>
            <slx:WinssDataGrid ID="LegacyDataGrid" runat="server" >
                <Columns>
            ...
            <slx:WinssDataGridColumn MergeRows="true" DataField="YearFormatted" HeaderText="&nbsp;" />
                    ...
                    <slx:WinssDataGridColumn DataField="Not Completing Percent" FormatString="#,##0.0%" HeaderText="% Not Known to be Continuing"/>
                    ...
                    <slx:WinssDataGridColumn DataField="Total Expected to Complete High School Percent" FormatString="#,##0.0%" HeaderText="% Known to be Continuing"/>
                    <slx:WinssDataGridColumn DataField="Certificates Percent" FormatString="#,##0.0%"/>
                    <slx:WinssDataGridColumn DataField="Regular Diplomas Percent" FormatString="#,##0.0%"/>
                    <slx:WinssDataGridColumn DataField="HSEDs Percent" FormatString="#,##0.0%"/>
...
<br><SPAN class="text"><p>**Total Expected to Complete High School is a count of students who were expected to complete high school in the year indicated whether or not the students actually did.  This total includes actual high school completers, cohort dropouts, and noncompleters who reached the maximum age associated with the constitutional right to a free public education. <a href="javascript:popup('http://dpi.wi.gov/winss/perfacademic_glossary.html#expected_completer')" onClick="setCookie(question, url)">[More]</a></SPAN><SPAN class="text">	
            ...
            <SPAN class="text">
	            <p><a href="javascript:popup('http://dpi.wi.gov/spr/grad_use.html')" onClick="setCookie(question, url)">What are some questions to consider when reviewing these graphs?</a>
            </SPAN>        
        </td>
    </tr>
</table>
