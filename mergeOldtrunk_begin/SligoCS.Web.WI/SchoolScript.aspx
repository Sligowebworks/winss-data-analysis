<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="SchoolScript.aspx.cs" Inherits="SligoCS.Web.WI.SchoolScript" Title="WI Select a School - Data Analysis" %>
...
<table style="padding:0px 0px 0px 0px; width: 390px;"><tr><td align="left">
    <cc1:SligoDataGrid ID="SligoDataGrid1" runat="server" AutoGenerateColumns="False" ShowSuperHeader="True" BorderStyle="None" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left" SuperHeaderText="">
     <Columns >
     ...
     <Columns >
        ...
        <asp:TemplateField HeaderText="SCHOOL" ItemStyle-HorizontalAlign="Left">
            <ItemTemplate>
                ...
                + GetShowSchoolQueryStringForMultipleParams ( Eval("fullkey").ToString() + "&SEARCHTYPE=SC&L=0"                        ) %>'              
                Text='Show Schools' />
            </ItemTemplate>
        </asp:TemplateField>
...
<!--//This is the show school lins for County (Click 
    ...
    <cc1:SligoDataGrid ID="SligoDataGrid3"  runat="server" AutoGenerateColumns="False" ShowSuperHeader="true" BorderStyle="None" CellSpacing="0" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" ShowHeader="true" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left">
     <Columns >
        <asp:BoundField DataField="CountyName" HeaderText="COUNTY" ItemStyle-HorizontalAlign="Left">     
        </asp:BoundField>
...
<!-- Schools Display 2-->   
    <cc1:SligoDataGrid ID="SligoDataGrid4" runat="server" AutoGenerateColumns="False" ShowSuperHeader="true" BorderStyle="None" CellSpacing="0" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" ShowHeader="true" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left">
     <Columns >
        <asp:BoundField DataField="CountyName" HeaderText="COUNTY" ItemStyle-HorizontalAlign="Left">
        </asp:BoundField>
...
<asp:Panel ID="pnl_Map_1" Visible="false" runat="server">
    <asp:Label ID="Map_1_Head_Label" CssClass="title" Text="CESA 1: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /> 
    <asp:HyperLink ID="Map_1_Link" BackColor="#EFEFEF" Text="View map that includes union high  school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=1&HS=1" runat="server" />
    <uc1:CESA_Map_1 id="CESA_Map_1_1" runat="server" />  
</asp:Panel>

<asp:Panel ID="pnl_Map_1_2" Visible="false" runat="server">
    <asp:Label ID="Map_1_2_Head_Label" CssClass="title" Text="CESA 1: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /> 
    <asp:HyperLink ID="Map_1_Link_2" BackColor="#EFEFEF" Text="View map that includes elementary school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=1&HS=0" runat="server" />
    <uc13:CESA_Map_1_2 ID="CESA_Map_1_2_1" runat="server" />    
</asp:Panel>

<asp:Panel ID="pnl_Map_2" Visible="false" runat="server">   
    <asp:Label ID="Map_2_Head_Label" CssClass="title" Text="CESA 2: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /> 
    <asp:HyperLink ID="Map_2_Link_1" BackColor="#EFEFEF" Text="View map that includes union high  school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=2&HS=1" runat="server" /> 
...
<asp:Panel ID="pnl_Map_2_2" Visible="false" runat="server">   
    ...
    <asp:HyperLink ID="Map_2_Link_2" BackColor="#EFEFEF" Text="View map that includes elementary school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=2&HS=0" runat="server" /> 
    <uc14:CESA_Map_2_2 id="CESA_Map_2_2" runat="server" />
</asp:Panel>

<asp:Panel ID="pnl_Map_3" Visible="false" runat="server">   
    <asp:Label ID="Map_3_Head_Label" CssClass="title" Text="CESA 3: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />   
    <uc3:CESA_Map_3 id="CESA_Map_3_1" runat="server" />  
</asp:Panel>

<asp:Panel ID="pnl_Map_4" Visible="false" runat="server">   
   <asp:Label ID="Map_4_Head_Label" CssClass="title" Text="CESA 4: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />   
   <uc4:CESA_Map_4 id="CESA_Map_4_1" runat="server" />    
</asp:Panel>

<asp:Panel ID="pnl_Map_5" Visible="false" runat="server"> 
   <asp:Label ID="Map_5_Head_Label" CssClass="title" Text="CESA 5: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />       
   <uc5:CESA_Map_5 id="CESA_Map_5_1" runat="server" />      
</asp:Panel>

<asp:Panel ID="pnl_Map_6" Visible="false" runat="server" Width="400px">    
    <asp:Label ID="Map_6_Head_Label" CssClass="title" Text="CESA 6: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /><br />
    <asp:HyperLink ID="Map_6_Link_1" BackColor="#EFEFEF" Text="View map that includes union high school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=6&HS=1" runat="server"  /><br />
    <uc6:CESA_Map_6 id="CESA_Map_6_1" runat="server" />   
</asp:Panel>

<asp:Panel ID="pnl_Map_6_2" Visible="false" runat="server" Width="400px">    
    <asp:Label ID="Map_6_2_Head_Label" CssClass="title" Text="CESA 6: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />
    <asp:HyperLink ID="Map_6_Link_2" BackColor="#EFEFEF" Text="View map that includes elementary school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=6&HS=0" runat="server" /><br /><br />
    <uc15:CESA_Map_6_2 id="CESA_Map_6_2" runat="server" />
</asp:Panel>

<asp:Panel ID="pnl_Map_7" Visible="false" runat="server">     
    <asp:Label ID="Map_7_Head_Label" CssClass="title" Text="CESA 7: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" Width="130px" /><br />
    <uc7:CESA_Map_7 id="CESA_Map_7_1" runat="server" />      
</asp:Panel>

<asp:Panel ID="pnl_Map_8" Visible="false" runat="server"> 
   <asp:Label ID="Map_8_Head_Label" CssClass="title" Text="CESA 8: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />     
   <uc8:CESA_Map_8 id="CESA_Map_8_1" runat="server" />       
</asp:Panel>

<asp:Panel ID="pnl_Map_9" Visible="false" runat="server">  
    <asp:Label ID="Map_9_Head_Label" CssClass="title" Text="CESA 9: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />    
   <asp:HyperLink ID="Map_9_Link" BackColor="#EFEFEF" Text="View map that includes union high  school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=9&HS=1" runat="server" />
   <uc9:CESA_Map_9 id="CESA_Map_9_1" runat="server" />        
</asp:Panel>

<asp:Panel ID="pnl_Map_9_2" Visible="false" runat="server">  
    <asp:Label ID="Map_9_2_Head_Label" CssClass="title" Text="CESA 9: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br />
    <asp:HyperLink ID="Map_9_2_Link" BackColor="#EFEFEF" Text="View map that includes elementary school districts" Font-Size="12px" NavigateUrl="~/SchoolScript.aspx?SEARCHTYPE=CE&L=9&HS=0" runat="server" />
    <uc16:CESA_Map_9_2 id="CESA_Map_9_2_1" runat="server" />         
</asp:Panel>

<asp:Panel ID="pnl_Map_10" Visible="false" runat="server">     
   <asp:Label ID="Map_10_Head_Label" CssClass="title" Text="CESA 10: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /> 
   <uc10:CESA_Map_10 id="CESA_Map_10_1" runat="server" />  
 </asp:Panel>
 
<asp:Panel ID="pnl_Map_11" Visible="false" runat="server">   
   <asp:Label ID="Map_11_Head_Label" CssClass="title" Text="CESA 11: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /> 
   <uc11:CESA_Map_11 id="CESA_Map_11_1" runat="server" />       
 </asp:Panel>
 
<asp:Panel ID="pnl_Map_12" Visible="false" runat="server">    
   <asp:Label ID="Map_12_Head_Label" CssClass="title" Text="CESA 12: Click on a School District or hot link below" BackColor="#EFEFEF" runat="server" /><br /> 
   <uc12:CESA_Map_12 id="CESA_Map_12_1" runat="server" />       
</asp:Panel>

<!--//CESA -->
    <cc1:SligoDataGrid ID="SligoDataGrid5"  runat="server" AutoGenerateColumns="False" ShowSuperHeader="true" BorderStyle="None" CellSpacing="0" HeaderStyle-BackColor="#EFEFEF" HeaderStyle-Font-Underline="true" HeaderStyle-HorizontalAlign="Left" UseAccessibleHeader="False" CellPadding="4" ShowHeader="true" HeaderStyle-Font-Bold="true" RowStyle-Font-Size="8pt" GridLines="None" RowStyle-HorizontalAlign="Left">
     <Columns >
        <asp:BoundField DataField="CountyName" HeaderText="COUNTY">     
        ...
        <asp:TemplateField HeaderText="DISTRICT" ItemStyle-Width="125" ItemStyle-HorizontalAlign="Left">
            ...
            NavigateUrl='<%# "~/questions.aspx?FULLKEY=" + Eval("fullkey") + 
