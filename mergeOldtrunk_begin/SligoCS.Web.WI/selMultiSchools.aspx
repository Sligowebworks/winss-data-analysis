<%@ Page Language="C#" MasterPageFile="~/WI.Master" AutoEventWireup="true" CodeBehind="selMultiSchools.aspx.cs" Inherits="SligoCS.Web.WI.selMultiSchools" Title="Selecting Comparable schools" %>
...
<asp:Label ID="Label1" runat="server" Text="Selecting Multiple Schools" />
</td></tr>
...
<td align="left" class="title" style="padding:0px 0px 0px 0px; width: 100%;">
    ...
    <td class="smtext" style="padding:0px 0px 0px 5px; width: 50%;">
        <asp:RadioButton ID="Radio4Schools" GroupName="FourOrAllSchools"  Checked="true" runat="server" />Select up to four schools in</td>
    <td class="smtext"style="padding:0px 0px 0px 5px; width: 50%;">
        <asp:RadioButton ID="RadioAllSchools" runat="server" GroupName="FourOrAllSchools" />Select all schools in<br />(with this option pages may be slow to download)</td>
    </tr>
    </table>  
</td></tr>
...
<asp:table ID="TableSchoolList" width="390" BorderWidth="2" BorderStyle="Double" runat="server" >
<asp:TableRow>
    <asp:TableCell BackColor="Gainsboro" cssClass="smtext" runat="server">
			Currently Selected Schools 
		</asp:TableCell>
